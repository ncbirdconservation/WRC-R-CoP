...
It is often good to print out messages while a long script is running, just to let the user know that it is working. To do this, you can use the following code:
